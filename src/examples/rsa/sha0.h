...
ATTRIBUTE_WARN_UNUSED_RET static int sha0_init(sha0_context *ctx)
{
	int ret;
...
ATTRIBUTE_WARN_UNUSED_RET static inline int sha0_update(sha0_context *ctx, const u8 *input, u32 ilen)
{
...
ATTRIBUTE_WARN_UNUSED_RET static inline int sha0_final(sha0_context *ctx, u8 output[SHA0_DIGEST_SIZE])
{
 ...
 */
ATTRIBUTE_WARN_UNUSED_RET static inline int sha0_scattered(const u8 **inputs, const u32 *ilens,
 ...
 * Returns 0 on success, -1 on error.
 */
ATTRIBUTE_WARN_UNUSED_RET static inline int sha0(const u8 *input, u32 ilen, u8 output[SHA0_DIGEST_SIZE])
{
	sha0_context ctx;
	int ret;
