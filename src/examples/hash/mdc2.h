...
ATTRIBUTE_WARN_UNUSED_RET static inline int mdc2_set_padding_type(mdc2_context *ctx,
								padding_type p)
{
	int ret;
...
ATTRIBUTE_WARN_UNUSED_RET static int mdc2_init(mdc2_context *ctx)
{
	int ret;
...
ATTRIBUTE_WARN_UNUSED_RET static inline int mdc2_update(mdc2_context *ctx, const u8 *input, u32 ilen)
{
...
ATTRIBUTE_WARN_UNUSED_RET static inline int mdc2_final(mdc2_context *ctx, u8 output[MDC2_DIGEST_SIZE])
{
	int ret;
	unsigned int i;
	u8 pad_byte;
 ...
 */
ATTRIBUTE_WARN_UNUSED_RET static inline int mdc2_scattered(const u8 **inputs, const u32 *ilens,
 ...
 * returns 0 on success, -1 on error.
 */
ATTRIBUTE_WARN_UNUSED_RET static inline int mdc2_scattered_padding1(const u8 **inputs, const u32 *ilens,
 ...
 * returns 0 on success, -1 on error.
 */
ATTRIBUTE_WARN_UNUSED_RET static inline int mdc2_scattered_padding2(const u8 **inputs, const u32 *ilens,
		      u8 output[MDC2_DIGEST_SIZE])
{
 ...
 * Returns 0 on success, -1 on error.
 */
ATTRIBUTE_WARN_UNUSED_RET static inline int mdc2(const u8 *input, u32 ilen, u8 output[MDC2_DIGEST_SIZE], padding_type p)
{
	mdc2_context ctx;
	int ret;
 ...
 * Returns 0 on success, -1 on error.
 */
ATTRIBUTE_WARN_UNUSED_RET static inline int mdc2_padding1(const u8 *input, u32 ilen, u8 output[MDC2_DIGEST_SIZE])
{
 ...
 * Returns 0 on success, -1 on error.
 */
ATTRIBUTE_WARN_UNUSED_RET static inline int mdc2_padding2(const u8 *input, u32 ilen, u8 output[MDC2_DIGEST_SIZE])
{
