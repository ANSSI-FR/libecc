...
/* All the innder MD-5 operations */
...
ATTRIBUTE_WARN_UNUSED_RET static int md5_init(md5_context *ctx)
{
	int ret;
...
ATTRIBUTE_WARN_UNUSED_RET static inline int md5_update(md5_context *ctx, const u8 *input, u32 ilen)
{
...
ATTRIBUTE_WARN_UNUSED_RET static inline int md5_final(md5_context *ctx, u8 output[MD5_DIGEST_SIZE])
{
 ...
 */
ATTRIBUTE_WARN_UNUSED_RET static inline int md5_scattered(const u8 **inputs, const u32 *ilens,
 ...
 * Returns 0 on success, -1 on error.
 */
ATTRIBUTE_WARN_UNUSED_RET static inline int md5(const u8 *input, u32 ilen, u8 output[MD5_DIGEST_SIZE])
{
	md5_context ctx;
	int ret;
