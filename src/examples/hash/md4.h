...
ATTRIBUTE_WARN_UNUSED_RET static int md4_init(md4_context *ctx)
{
	int ret;
...
ATTRIBUTE_WARN_UNUSED_RET static inline int md4_update(md4_context *ctx, const u8 *input, u32 ilen)
{
...
ATTRIBUTE_WARN_UNUSED_RET static inline int md4_final(md4_context *ctx, u8 output[MD4_DIGEST_SIZE])
{
 ...
 */
ATTRIBUTE_WARN_UNUSED_RET static inline int md4_scattered(const u8 **inputs, const u32 *ilens,
 ...
 * Returns 0 on success, -1 on error.
 */
ATTRIBUTE_WARN_UNUSED_RET static inline int md4(const u8 *input, u32 ilen, u8 output[MD4_DIGEST_SIZE])
{
	md4_context ctx;
	int ret;
