...
ATTRIBUTE_WARN_UNUSED_RET static int md2_init(md2_context *ctx)
{
	int ret;
...
ATTRIBUTE_WARN_UNUSED_RET static inline int md2_update(md2_context *ctx, const u8 *input, u32 ilen)
{
...
ATTRIBUTE_WARN_UNUSED_RET static inline int md2_final(md2_context *ctx, u8 output[MD2_DIGEST_SIZE])
{
	int ret;
	unsigned int i;
	u8 pad_byte;
 ...
 */
ATTRIBUTE_WARN_UNUSED_RET static inline int md2_scattered(const u8 **inputs, const u32 *ilens,
 ...
 * Returns 0 on success, -1 on error.
 */
ATTRIBUTE_WARN_UNUSED_RET static inline int md2(const u8 *input, u32 ilen, u8 output[MD2_DIGEST_SIZE])
{
	md2_context ctx;
	int ret;
