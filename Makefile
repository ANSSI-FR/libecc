...
HASH_SRC = $(wildcard src/hash/sha*.c) src/hash/hash_algs.c src/hash/sm3.c src/hash/gost.c
...
SIG_SRC = $(wildcard src/sig/*dsa.c) src/sig/ecsdsa_common.c src/sig/sig_algs.c src/sig/sm2.c
